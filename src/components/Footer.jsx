...
<footer className="flex text-gray-100 bg-blue-400 dark:text-white dark:bg-black body-font sticky sticky-footer bottom-0 w-full ">
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col ">    
    ...
    <p className="text-sm text-gray-200 sm:ml-4 sm:pl-4 sm:border-l-2 border-gray-300 dark:border-gray-800 sm:py-2 sm:mt-0 mt-4">© GNU General Public License v3.0
    <a href="https://www.gnu.org/licenses/gpl-3.0.en.html" className="text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 border-gray-300 dark:border-gray-800 sm:py-2 sm:mt-0 mt-4 ml-1" target="_blank" rel="noopener noreferrer">Copyright Policy</a>      
    </p>
