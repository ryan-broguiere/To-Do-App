...
const TodoForm = () => {
    ...
    return (      
    <form onSubmit={inputHandler} className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end sm:space-x-4 sm:space-y-0 space-y-4 mb-6 mt-2">
      <div className="relative sm:mb-0 flex-grow w-full">
        <label htmlFor="task" className="leading-7 text-sm text-gray-300">Enter Task</label>
